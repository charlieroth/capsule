...
mod tests {
    ...
    fn test_sanitize_removes_dangerous_elements() {
        let mut result = ReadabilityResult {
            ...
            html: r#"<p>Hello world</p><script>alert('xss')</script><style>body{color:red}</style>"#.to_string(),
        };
    ...
    fn test_resolve_relative_links() {
        let mut result = ReadabilityResult {
            ...
            html: r#"<p><a href="/page">Click here</a></p><img src="image.jpg" alt="test">"#.to_string(),
        };
        ...
        assert!(result.html.contains("https://example.com/article/image.jpg"));
    }
